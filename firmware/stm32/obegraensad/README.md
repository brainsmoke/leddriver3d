...
The pinout on the leddriver3d board (v4.0, with integrated level shifters):

<img src="/img/obegraensad_driver_wiring.jpg" width="640" alt="photo of pinout on the leddriver3d board (v4.0)">
